...
const ModalEliminarMaterialD = ({ show, onClose, onConfirm }) => {
  if (!show) return null;
      ...
      <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          <div className={styles.infoActions}>
            ...
            <p className={styles.textInfo}>Estás a punto de eliminar este material didáctico de forma permanente.</p>
