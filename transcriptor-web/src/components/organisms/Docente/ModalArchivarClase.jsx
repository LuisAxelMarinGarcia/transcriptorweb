...
const ModalArchivarClase = ({ show, onClose }) => {
            ...
            <div className={styles.modalContent}>
                ...
                <form action="" className={styles.form}>
                    <div className={styles.infoActions}>
                        ...
                        <p className={styles.textInfo}>Estás a punto de archivar esta clase. Esto significa que ya no estará disponible para ediciones ni modificaciones. Podrás acceder a la clase en modo lectura desde la sección de archivadas. </p>
                    </div>
